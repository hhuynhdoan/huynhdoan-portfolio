                    ...
                    <div className="main__content-bottom font-16 font-500">
                        <div className="text-top">
                            ...
                            <div className="text-github">
                                <span className="text-violet">const</span> <span className="text-green">githubLink</span> <span className="text-orange"> <a href="https://github.com/hhuynhdoan/huynhdoan-portfolio" className="text-orange"> = “https://github.com/hhuynhdoan/huynhdoan-portfolio”</a></span>
                            </div>
                        </div>
                    </div>
                </div>
